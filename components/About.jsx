    ...
    <div id="about" className="w-full md:h-screen p-2 flex items-center py-16">
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className="col-span-2">
          ...
          <p className="py-2 text-gray-600">
            Lover of martial arts, languages and the piano. I have always had a
            knack for technology and working with computers. In 2021 I started
            working with HTML & CSS to make some minor edits on a small business
          ...
          <p className="py-2 text-gray-600">
            ...
            freelancing for e-commerce companies on my country. I am now
            spending my time building projects with React JS, NextJs, and
